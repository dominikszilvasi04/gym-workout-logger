      ...
      <div className="min-w-0 flex flex-col gap-1">
        ...
        <input
          ...
          className={clsx(
            ...
            isDateLikeInput && "overflow-hidden h-11 px-3 pr-10 text-base text-left leading-normal [text-align-last:left] [&::-webkit-date-and-time-value]:text-left [&::-webkit-datetime-edit]:text-left [&::-webkit-datetime-edit-fields-wrapper]:justify-start [&::-webkit-calendar-picker-indicator]:ml-1",
