...
class WorkoutTemplateRepository:
    ...
    def create_workout_template(self, workout_template_document: WorkoutTemplateDocument) -> str:
        ...
        """
        document_dictionary: Dict[str, Any] = workout_template_document.model_dump(by_alias=True, exclude={"identifier"})
        insertion_result = self.collection.insert_one(document_dictionary)
        logger.info("Workout template inserted with identifier=%s", str(insertion_result.inserted_id))
    ...
    def retrieve_all_workout_templates(self, user_identifier: Optional[str] = None) -> List[WorkoutTemplateDocument]:
        """
    ...
    def delete_workout_template_by_identifier(self, identifier: str, user_identifier: Optional[str] = None) -> bool:
        """
