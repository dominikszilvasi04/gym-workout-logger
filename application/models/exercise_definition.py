...
class ExerciseDefinition(BaseModel):
    ...
    exercise_name: str = Field(..., min_length=1, description="The standardised name of the exercise (e.g., 'Barbell Bench Press').")
    primary_muscle_group: str = Field(..., min_length=1, description="The main muscle group targeted (e.g., 'Chest').")
    equipment_required: str = Field(default="None", description="The equipment needed (e.g., 'Barbell', 'Dumbbell', 'Machine').")