    ...
    workout_document = WorkoutDocument(
        ...
        exercises=[
            ExerciseLog(
                ...
                sets=[
                    WorkoutSet(repetitions=8, weight_in_kilograms=80.0, rate_of_perceived_exertion=None),
                    WorkoutSet(repetitions=6, weight_in_kilograms=85.0, rate_of_perceived_exertion=8),
                    WorkoutSet(repetitions=5, weight_in_kilograms=90.0, rate_of_perceived_exertion=9),
                ],
            )
        ],
    )
...
def test_build_dashboard_analytics_excludes_workouts_without_rpe_from_rpe_averages() -> None:
    ...
    workout_with_rpe = WorkoutDocument(
        ...
        exercises=[
            ExerciseLog(
                exercise_name="Bench Press",
                sets=[WorkoutSet(repetitions=5, weight_in_kilograms=100.0, rate_of_perceived_exertion=9)],
            )
        ],
    )
    workout_without_rpe = WorkoutDocument(
        ...
        exercises=[
            ExerciseLog(
                exercise_name="Row",
                sets=[WorkoutSet(repetitions=8, weight_in_kilograms=70.0, rate_of_perceived_exertion=None)],
            )
        ],
    )
